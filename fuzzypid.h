...
// 注意不能出现相等数据，会导致除法运算异常
float e[7][3] = {{-4.0, -3.0, -2.0}, // NB
				 {-3.0, -2.0, -1.0}, // NM
				 {-2.0, -1.0, 0},	 // NS
				 {-1.0, 0, 1.0},	 // ZO
				 {0, 1.0, 2.0},		 // PS
